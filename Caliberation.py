...
edges = ["K", "L-I", "L-2", "L-3"]
elements_dict = {}
with open("./data/Energies.txt") as atomicdata:
    dat = atomicdata.readlines()
    for i in range(22, 93):
        elements_dict[dat[i].split()[1]] = dict(zip(edges, dat[i].split()[2:6]))
...
def find_correct_foil(element='Cu', edge="K"):
    if element in ISS_foils.keys():
        ...
        if len(foils_options)==1:
            print("set_foil_to_this_value")
        else:
            foils_options = [(k, v) for k, v in foils_options.items()]
            print(foils_options[1])


# print(element_edge_itsvalue_sorted)
# print(ISS_element_edge_itsvalue_sorted)
# print(Elements_dictonary["Cu"].keys())

# for element in Elements_dictonary:
#     Elements_sorted_dictonary[element+"-"+element]

find_correct_foil(element="Tb", edge="L-3")
# if "L3" in ISS_foils['Ti']:
#     print('Yes')
# else:
#     print("No")


# print(ISS_foils.keys())
# print(Elements_dict)

# for keys, values in Elements_dict:
#     print(keys, values)

    # for i, lines in enumerate(dat):
    #     print(i, lines)




# dat = pd.DataFrame("./data/AtomicData.dat")
# print(ISS_foils)
